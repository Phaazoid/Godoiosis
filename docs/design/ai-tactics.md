...
- Downed enemies count nothing in pass 1; a second pass counts (and aims at) them only when pass 1 yields no candidate *for that member* — #57's deprioritization, preserved exactly.
