...
> 🔴 Her bio says she is **the one who first connects Isaac's abilities to alkahest theory** — but the doc itself carries a margin note disputing this (*"I thought Torv notices really early on…"*), and [Torv](torv.md)'s bio claims the early read. → [Q3](../appendix/open-questions.md#q3-who-first-identifies-isaacs-alkahest)
>
> *(New Hermes is the only named city tied to Paracelsus in the source; it's a candidate name for the Paracelsus capital — unconfirmed. See [Names TBD](../README.md#names-tbd).)*

**If Sophia had the Philosopher's Stone:** she would use it **for science.**
