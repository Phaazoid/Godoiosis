...
- The Will resource (bar, build/spend) and full rung selection (down vs maim vs overkill vs Crisis) depend on Fork 2 (individual-vs-squad) and Fork 3 (downed-attack kill-vs-maim). [Fork 1 is DECIDED (#8, 2026-06-21): Will PERSISTS -> store it on UnitInstance, NOT the transient Unit. The remaining DATA MODEL question is only whether a squad-level pool ALSO exists (Fork 2) — additive to the per-unit UnitInstance field, not a relocation.]
