...
const BOARD_SCOPED := {
	...
	"_flight_total": "BoardSpace.clear_staging(",   # #602 round 5: dies in _end_flight with elapsed
	...
	# #602 round 5: the cut flag rides the lift channel and dies in release_camera_lift with it.
