...
func test_water_then_shock_electrocutes() -> void:
	...
	(alch.get_equipped_weapon() as WeaponInstance).template.elemental_damage_type = Elemental.Element.WATER
	(mech.get_equipped_weapon() as WeaponInstance).template.elemental_damage_type = Elemental.Element.SHOCK
...
func test_e7_counter_can_complete_a_combo() -> void:
	...
	(e.get_equipped_weapon() as WeaponInstance).template.elemental_damage_type = Elemental.Element.SHOCK
