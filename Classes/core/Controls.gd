...
const ENTRIES: Array[Dictionary] = [
	...
	{"key": "Enter", "context": Context.BOARD, "when": "deploying, before a mission starts",
		"does": "Begin the mission with the force you have placed, after a card asks whether you are sure -- there is no coming back to the loadout once the battle starts. Refused outright while nobody is on the board, and that refusal is not asked about first. Begin Mission sits beside Loadout in the board's bottom-right corner, and on the menu itself.",
