...
const ENTRIES: Array[Dictionary] = [
	...
	{"key": "Tab", "context": Context.BOARD, "when": "deploying, before a mission starts",
		"does": "Swap between the pre-mission menu and the board it is sitting on. The menu keeps its place, so looking at the ground you are about to fight over costs nothing.",
