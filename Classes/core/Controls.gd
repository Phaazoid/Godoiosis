...
const ENTRIES: Array[Dictionary] = [
	...
	{"key": "Left-click", "context": Context.BOARD, "when": "deploying, before a mission starts",
		"does": "On one of your units, opens what you may still change about it -- squads, and taking it back off the board. On an empty cell inside the deployment zone, offers the units still waiting. There is no action ring here: nothing is taking a turn yet.",
		"action": HARDCODED},
